const operateColumn = [
    {
        ...
        placeholder: "公里",
        tips: "运营团队可运营的最大范围",
        key: "operate_map_range"
    },
    {
        label: "每公里的价格范围",
        required: true,
        tips: "运营团队每公里定价的范围区间",
        key: "operate_price_range"
    },
    {
        label: "结算申请间隔时间",
        type: "inputNumber",
        min: 0,
        placeholder: "天",
        tips: "运营团队每次申请结算间隔的天数",
        key: "operate_settlement_apart"
    },
    {
        label: "结算最多订单数",
        type: "inputNumber",
        min: 1,
        placeholder: "单",
        tips: "运营团队每次申请结算订单数的最大值",
        key: "operate_settlement_maxOrderNum"
    },
    {
        label: "结算最小金额",
        type: "inputNumber",
        min: 0,
        placeholder: "天",
        tips: "运营团队每次申请结算的最小金额限制",
        key: "operate_settlement_minPrice"
    },
];
...
const operateRules = {
    ...
    operate_settlement_apart: [
        { required: true, message: '请输入结算申请间隔时间', trigger: 'blur' },
    ],
    operate_price_range_min: [
        { required: true, message: '请输入价格范围最小值', trigger: 'blur' },
    ],
    operate_price_range_max: [
        { required: true, message: '请输入价格范围最大值', trigger: 'blur' },
    ],
    operate_settlement_maxOrderNum: [
        { required: true, message: '请输入结算最多订单数', trigger: 'blur' },
    ],
    operate_settlement_minPrice: [
...
const orderColumn = [
    ...
    },
    {
        ...
        min: 0,
        tips: "订单完成后多少天后自动好评",
        key: "order_complete_goodComment"
    },
    {
        label: "已完成订单允许售后",
        type: "inputNumber",
    ...
    },
    {
        ...
        placeholder: "点",
        tips: "订单完成后赠送多少积分",
        key: "order_complete_getIntegral"
    }
];
...
const orderRules = {
    ...
    order_complete_goodComment: [
        { required: true, message: '请输入订单自动好评时间', trigger: 'blur' },
    ],
    order_complete_afterSale: [
        { required: true, message: '请输入已完成订单允许售后时间', trigger: 'blur' },
    ],
    order_complete_getIntegral: [
        { required: true, message: '请输入完成订单赠送积分数量', trigger: 'blur' },
    ]
};
